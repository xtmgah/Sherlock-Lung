# ------------------------------------------------------------------------------
# Script: Figure 1 - Tumor Evolution Analysis (LUAD cohort)
...
load('./data/DP_info_data.RData')
load('./data/covdata0.RData')
load('./data/Signature_Lumidl.RData')
load('./data/Mutation_Signature_Probability_SBS.RData', verbose = TRUE)
load('./data/sherlock_maf.RData')
load('./data/sherlock_driver_mutations.RData')
load('./data/sherlock_mt.RData')
load('./data/sigcol.RData')
...
# ------------------------------------------------------------------------------
# Fig. 1a: Cohort Overview with Sankey Diagram
# ------------------------------------------------------------------------------
...
# =================== 7. Fig. 1d - Mutation Clonality Ratio =================
...
# ========================= 8. Fig. 1e - Driver Gene Frequency by Clonality =========================
...
# 
# # =============== 9. Fig. 1f - ID2/ASCETIC Group Patterns (removed from mansucripts) ==================
# 
...
# =============== 10. Fig. 1f - Mutational Signature Enrichment =============
...
source(
  "/Users/zhangt8/NIH-Work/MutationSignature/mSigPortal/CBIIT/mSigPortal/Codes/Sigvisualfunc.R"
)
